...
<form
		class="mt-8 md:mt-20 font-body italic text-xl md:text-2xl mx-auto flex flex-col"
		transition:slide={{duration: 250, easing: sineOut}}
>
	<div class="flex flex-row gap-x-10 gap-y-5 flex-wrap mb-3">
		<div class="w-full md:w-auto">
			<label for="first_name" class="block ml-3">Prenume</label>
			<input id="first_name" type="text" name="first_name" class="w-full md:w-auto rounded border-primary">
		</div>
		<div class="w-full md:w-auto">
			<label for="last_name" class="block ml-3">Nume</label>
			<input id="last_name" type="text" name="last_name" class="w-full md:w-auto rounded border-primary">
		</div>
	</div>
	<label for="additional_guest" class="flex relative items-center cursor-pointer mb-3">
	...
	{#if (guest && rsvp)}
		<div class="flex flex-row gap-x-10 gap-y-5 flex-wrap mb-3" transition:slide={{duration: 250, easing: sineOut}}>
			<div class="w-full md:w-auto">
				<label for="first_name_guest" class="block ml-3">Prenume</label>
				<input
						id="first_name_guest"
						type="text"
			...
			<div class="w-full md:w-auto">
				<label for="last_name_guest" class="block ml-3">Nume</label>
				<input
						id="last_name_guest"
						type="text"
	...
	{/if}
	<label for="child" class="flex relative items-center cursor-pointer mb-10">
	...
	<label for="rsvp" class="flex relative items-center cursor-pointer mb-8">
	...
	<button class="text-center px-8 py-2 font-semibold text-xl bg-secondary text-white rounded-md shadow-sm hover:-translate-y-1 hover:scale-110 hover:bg-primary ease-in-out delay-50 duration-300">
		RSVP
	</button>
</form>
